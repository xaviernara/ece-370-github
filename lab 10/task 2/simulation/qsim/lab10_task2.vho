...
SIGNAL \present_state~15_combout\ : std_logic;
...
SIGNAL \ryg_ns~0_combout\ : std_logic;
SIGNAL \ryg_ns~1_combout\ : std_logic;
SIGNAL \ALT_INV_rst~input_o\ : std_logic;
SIGNAL \ALT_INV_ryg_ew~0_combout\ : std_logic;
...
\ALT_INV_ryg_ew~0_combout\ <= NOT \ryg_ew~0_combout\;
...
\present_state~15\ : cycloneive_lcell_comb
-- Equation(s):
-- \present_state~15_combout\ = (\car_ew~input_o\ & \present_state.GREEN_NS4~q\)
...
-- Equation(s):
-- \ryg_ew~0_combout\ = (\rst~input_o\) # (!\present_state.YELLOW_EW~q\)
...
\ryg_ns~0\ : cycloneive_lcell_comb
-- Equation(s):
-- \ryg_ns~0_combout\ = (!\rst~input_o\ & ((\present_state.YELLOW_EW~q\) # (\present_state.YELLOW_NS~q\)))
...
PORT MAP (
	...
	datad => \rst~input_o\,
	combout => \ryg_ns~0_combout\);

\ryg_ns~1\ : cycloneive_lcell_comb
-- Equation(s):
-- \ryg_ns~1_combout\ = (\rst~input_o\) # (!\present_state.YELLOW_NS~q\)
...
PORT MAP (
	dataa => \rst~input_o\,
	datad => \present_state.YELLOW_NS~q\,
	combout => \ryg_ns~1_combout\);
