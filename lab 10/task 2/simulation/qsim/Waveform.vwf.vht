...
-- *****************************************************************************
-- Generated on "12/12/2017 11:49:29"
                                                             
-- Vhdl Test Bench(with test vectors) for design  :          traffic_controller
-- 
...
ENTITY traffic_controller_vhd_vec_tst IS
END traffic_controller_vhd_vec_tst;
ARCHITECTURE traffic_controller_arch OF traffic_controller_vhd_vec_tst IS
-- constants                                                 
-- signals                                                   
