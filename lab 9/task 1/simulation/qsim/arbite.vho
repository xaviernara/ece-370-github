...
ARCHITECTURE structure OF arbiter_controller IS
...
-- Equation(s):
-- \Selector3~1_combout\ = (\R[2]~input_o\ & ((\Selector3~0_combout\) # ((\Selector0~0_combout\ & !\R[1]~input_o\))))
...
-- Equation(s):
-- \Selector3~0_combout\ = (\presentState.GNT_DEV2~q\) # ((\presentState.GNT_DEV1~q\ & !\R[1]~input_o\))
...
-- Equation(s):
-- \Selector0~1_combout\ = (\R[2]~input_o\) # ((!\Selector3~0_combout\ & ((\R[1]~input_o\) # (!\Selector0~0_combout\))))
...
-- Equation(s):
-- \Selector0~0_combout\ = (!\R[0]~input_o\ & ((\presentState.GNT_DEV0~q\) # (!\presentState.IDLE~q\)))
...
-- Equation(s):
-- \Selector2~0_combout\ = (\R[1]~input_o\ & ((\presentState.GNT_DEV1~q\) # (\Selector0~0_combout\)))
...
-- Equation(s):
-- \G~0_combout\ = (\presentState.GNT_DEV1~q\) # (\presentState.IDLE~q\ $ (!\presentState.GNT_DEV0~q\))
...
-- pragma translate_on
PORT MAP (
	dataa => \presentState.GNT_DEV1~q\,
	datab => \presentState.IDLE~q\,
	datac => \presentState.GNT_DEV0~q\,
	combout => \G~0_combout\);
