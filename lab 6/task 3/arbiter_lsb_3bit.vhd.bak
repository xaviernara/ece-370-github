...
entity arbiter_lsb_nbit is
	...
	port 
	(
		signal req : in std_logic_vector(3 downto 0);  --Request inputs
		signal grant : out std_logic_vector(3 downto 0); --Grant outputs
		signal z: out std_logic --Status bit indicating absence of requests
	);
