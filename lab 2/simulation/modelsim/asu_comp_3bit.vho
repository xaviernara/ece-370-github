...
-- sub	=>  Location: PIN_L2,	 I/O Standard: 2.5 V,	 Current Strength: Default
...
-- x[1]	=>  Location: PIN_M8,	 I/O Standard: 2.5 V,	 Current Strength: Default
...
SIGNAL \FA0|p~combout\ : std_logic;
SIGNAL \xor_sig0~combout\ : std_logic;
...
\FA0|p\ : cycloneive_lcell_comb
-- Equation(s):
-- \FA0|p~combout\ = \sub~input_o\ $ (\x[0]~input_o\ $ (\y[0]~input_o\))
...
PORT MAP (
	...
	datab => \x[0]~input_o\,
	datad => \y[0]~input_o\,
	combout => \FA0|p~combout\);

-- Location: LCCOMB_X1_Y44_N10
xor_sig0 : cycloneive_lcell_comb
-- Equation(s):
-- \xor_sig0~combout\ = \sub~input_o\ $ (\y[0]~input_o\)
...
-- Equation(s):
-- \xor_sig1~combout\ = \y[1]~input_o\ $ (\sub~input_o\)
...
-- Equation(s):
-- \FA1|sum~combout\ = \x[1]~input_o\ $ (\xor_sig1~combout\ $ (((\xor_sig0~combout\ & \x[0]~input_o\))))
...
-- pragma translate_on
PORT MAP (
	dataa => \xor_sig0~combout\,
	datab => \x[0]~input_o\,
	datac => \x[1]~input_o\,
	datad => \xor_sig1~combout\,
...
-- Equation(s):
-- \FA1|cout~0_combout\ = (\x[1]~input_o\ & ((\xor_sig1~combout\) # ((\xor_sig0~combout\ & \x[0]~input_o\)))) # (!\x[1]~input_o\ & (\xor_sig0~combout\ & (\x[0]~input_o\ & \xor_sig1~combout\)))
...
-- Equation(s):
-- \v~0_combout\ = \FA1|cout~0_combout\ $ (((\arith~input_o\ & ((\FA2|cout~0_combout\))) # (!\arith~input_o\ & (\sub~input_o\))))
